...
enum InventoryDetails: Int {
    case itemName = 0, itemShortName, active, color, cost, deptOpenKey, ebtItem, glyph, inheritTaxes, isGift, itemNotes, itemTags, lookup, minQty, openItem, price, printItem, qtyOnHand, tareWeight, unit, usesWeightScale, weighted
